...
export function NavbarWithSolidBackground() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 px-2 items-center flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant="large"
        color="blue-gray"
      ...
      >
        <Link to='/Nature' className="flex items-center font-bold focus:font-bold focus:text-yellow-600 hover:text-yellow-600">
          Nature
        </Link>
      </Typography>
      <Typography
